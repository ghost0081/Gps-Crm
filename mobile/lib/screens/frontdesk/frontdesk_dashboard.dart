...
class _FrontDeskDashboardState extends State<FrontDeskDashboard> {
  ...
  Future<void> _processQrScan({Map<String, dynamic>? qrData}) async {
    try {
      // Determine if QR is authentic (signed by our app)
      final bool isQrVerified = qrData != null && verifyQrSignature(qrData);
      ...
      // Show confirmation dialog with verification status
      _showConfirmationDialog(payload, studentDetails, isVerified: isQrVerified);
  ...
  void _showConfirmationDialog(Map<String, dynamic> payload, Map<String, dynamic> student, {bool isVerified = false}) {
    showDialog(
      context: context,
      barrierDismissible: false,
      builder: (ctx) {
                  ...
                  children: [
                    ...
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          Text(
                            isVerified ? 'Verified Gate Pass' : 'Unverified QR Code',
                            style: TextStyle(
                          ...
                          Text(
                            isVerified
                                ? 'This QR was generated by the school app — it\'s authentic.'
                                : 'This QR could not be verified. It may have been manually created or forged.',
                            style: TextStyle(
                              fontSize: 11,
                              color: isVerified ? const Color(0xFF047857) : const Color(0xFFB91C1C),
                            ),
                          ),
                        ],
                      ),
